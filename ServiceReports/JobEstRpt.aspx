<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobEstRpt.aspx.cs" Inherits="ServiceReports_JobEstRpt" %>
...
<body onload="hideLoading()">
    ...
    <div>
        ...
        <img alt="" src="../images/1.gif" title="Loading..." class="auto-style1" /><span 
            class="style7">Please wait...
    </span>
    </div>
