...
//                                "<div style='padding-left:15px; background:transparent no-repeat scroll 0 0;'>{desc}</div>" +
			...
			draggable:true,
			border:true,
			title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Administration</div>",
			id : "dash_adminwidget",
...
//                                "<div style='padding-left:15px; background:transparent no-repeat scroll 0 0;'>{desc}</div>" +
			...
			draggable:true,
			border:true,
			title: "<div wtf:qtip='Click to drag and place widget anywhere on the dashboard.'>Payroll</div>",
			id : "dash_payroll",
			tools: getToolsArray('jspfiles/rss.jsp?i=announcements&u=' + loginid)
});
}
